...
function MyProfile() {
  const [userData, setUserData] = useState({
    ...
    phone: '+91 8700119009',
    address: {
      line1: '57th cross, Ptana',
      line2: 'Circle, Banglore',
    },
    gender: 'Male',
    dob: '2002-09-22'
  })
  ...
  return (
    <div className='max-w-lg  flex flex-col gap-2 text-sm'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-netral-700'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          {
            isEdit ? 
            <input className='max-w-28 bg-gray-100' type='data' onChange={e => setUserData(prev => ({ ...prev, dob: e.target.value }))}/> : 
